...
/**
 * 固定标题的Scrollview (固定其xml中 android:tag="sticky"的元素)
 * @author hjw
 * @date 2015年3月16日
 */
public class StickyScrollView extends ScrollView
{
	...
	private void doTheStickyThing()
	{
		...
		if (viewThatShouldStick != null)
		{
			stickyViewTopOffset = approachingView == null ? 0 : Math.min(0, getTopForViewRelativeOnlyChild(approachingView) - getScrollY()
