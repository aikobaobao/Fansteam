...
//                    }
                    getParent().requestDisallowInterceptTouchEvent(true); //不阻止父容器的滚动事件
                }
                return super.dispatchTouchEvent(ev);
            }
        }
//        else{ // SLIDE_BORDER_MODE_NONE 的情况 TODO 测试商品详情的滚动是否正常
//            getParent().requestDisallowInterceptTouchEvent(false); 
//            return super.dispatchTouchEvent(ev);
//        }
//         getParent().requestDisallowInterceptTouchEvent(true); //hjw:
        // 不阻止父类拦截事件
